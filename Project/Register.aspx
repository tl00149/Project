...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="over" style="background-color: lightgray">
        ...
        <div class="registerContainer" style="margin-top: 2%; z-index: 100;">
        ...
        <div class="registerContainerThree">
            ...
            <div style="display: flex;">
                <div class="registerFont">First Name</div>
                <div class="registerFont" style="margin-left: 33%">Last Name</div>
            </div>
            <div style="display:flex; margin: 0 auto; justify-content: center;">
                <asp:TextBox class="registerName" style="margin-top: 0%;" id="txtRegFirst" type="text" name="userForm" value="" placeholder="First Name" runat="server"/>
                <asp:TextBox class="registerName" style="margin-top: 0%; margin-left: 15px;" id="txtRegLast" type="text" name="userForm" value="" placeholder="Last Name" runat="server"/>
            </div>
            ...
            <!--Email field-->
            <div class="registerFont">Email</div>
            <div>
                <asp:TextBox class="registerName" style="margin-top: 0%; margin-left: 3%; width: 92%;" id="txtRegEmail" type="text" name="userForm" value="" placeholder="Email" runat="server"/>
                ...
                <!--Password-->
                <div class="registerFont">Password</div>
                ...
                <div class="registerFont">Confirm Password</div>
                <asp:TextBox class="registerNamePass" style="margin-top: 0%; margin-left: 3%; width: 92%;" id="txtRegPassConfirm" type="Password" name="userForm" value="" placeholder="Confirm Password" runat="server"/>
                <div>
                ...
                <!--YOB-->
                <div class="registerFont">Year of Birth</div>
                <asp:TextBox class="registerName" style="margin-top: 0%; margin-left: 3%; width: 92%;" id="txtRegYOB" type="Text" InitialValue="YYYY" name="userForm" value="" placeholder="Year of Birth" runat="server"/>
                <div>
                ...
                <!--Address and so on-->
                <div class="registerFont">Address</div>
                ...
                <div style="display: flex;">
                    <div class="registerFont">City</div>
                    <div class="registerFont" style="margin-left: 43%">Zip Code</div>
                </div>
                <div style="display:flex; margin: 0 auto; justify-content: center;">
                    ...
                    <asp:TextBox class="registerName" style="margin-top: 0%; margin-left: 15px;" id="txtRegZip" type="text" name="userForm" value="" placeholder="Zip Code" runat="server"/>
                </div>
                <div style="display:flex; margin: 0 auto;">
                    ...
                    <asp:RequiredFieldValidator Class="registerError" ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter a ZIP code" ControlToValidate="txtRegZip" style="margin-left: 35%"></asp:RequiredFieldValidator>
                </div>
                <div class="registerFont">Account Type</div>
                <asp:DropDownList runat="server" id="styFall" class="select2">
                    <asp:ListItem Value="1">Sign up as Customer</asp:ListItem>
                    <asp:ListItem Value="2">Sign up as Employee</asp:ListItem>
                </asp:DropDownList>
